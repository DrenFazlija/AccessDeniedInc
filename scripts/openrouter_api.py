...
if __name__ == '__main__':
    ...
    from utils import get_openrouter_credentials

    api_key = get_openrouter_credentials(args.api_key_path)
    ...
    with open(batch_input_path, 'r') as f:
        for i, line in enumerate(tqdm(f, total=sum(1 for _ in open(batch_input_path)))):
            ...
            response_dict['id'] = request['custom_id']  # Add the id to the response
